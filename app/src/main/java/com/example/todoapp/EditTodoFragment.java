...
public class EditTodoFragment extends Fragment {
    ...
    //view elements
    View rootView;
    EditText txtAuthor, txtTitle, txtDescription, txtDate;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtAuthor = rootView.findViewById(R.id.edit_txt_author);
        ...
        if (todoId!=-1){
            ...
            txtAuthor.setText(todo.getAuthor());
    ...
    void AddTodo(){
        ...
        if (txtAuthor.getText().toString().trim().equals("")){
            txtAuthor.setError("Description cannot be empty");
            txtTitle.requestFocus();
            validate = false;
        }
        ...
        todo.setAuthor(txtAuthor.getText().toString());
        try {
            DateFormat formatter;
            formatter=new SimpleDateFormat("yyyy-MM-dd");
