...
public class TodoListFragment extends Fragment {
    ...
    private class TodoHolder extends RecyclerView.ViewHolder{
        TextView mTitle, mDate, mDescrition ,mAuthor;
        public TodoHolder(LayoutInflater inflater, ViewGroup parentViewGroup) {
            ...
            mAuthor=itemView.findViewById(R.id.list_author);
            mDescrition=itemView.findViewById(R.id.list_description);
            ...
            mDescrition.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    TodoAdapter adapter = new TodoAdapter(mTodoViewModel.getAllTodos().getValue());
                    int position = getAdapterPosition();
        ...
        public void bind(Task todo){
            ...
            mAuthor.setText(todo.getAuthor());
            mDescrition.setText(todo.getDescription());
