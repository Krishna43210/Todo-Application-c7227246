  ...
  public TodoDAO_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `tasks` (`id`,`title`,`author`,`description`,`created_date`,`is_completed`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Task value) {
        ...
        final int _tmp_1;
        _tmp_1 = value.isIs_completed() ? 1 : 0;
    ...
    this.__updateAdapterOfTask = new EntityDeletionOrUpdateAdapter<Task>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR REPLACE `tasks` SET `id` = ?,`title` = ?,`author` = ?,`description` = ?,`created_date` = ?,`is_completed` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfDeleteCompleted = new SharedSQLiteStatement(__db) {
      @Override
      public String createQuery() {
        final String _query = "Delete From tasks where is_completed=1";
        return _query;
      }
    };
  }
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            final boolean _tmpIs_completed;
            final int _tmp_1;
            _tmp_1 = _cursor.getInt(_cursorIndexOfIsCompleted);
            _tmpIs_completed = _tmp_1 != 0;
            _item = new Task(_tmpTitle,_tmpAuthor,_tmpDescription,_tmpCreatedDate,_tmpIs_completed);
            final int _tmpId;
  ...
  public Task getTodoById(final int id) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        _tmp_1 = _cursor.getInt(_cursorIndexOfIsCompleted);
        _tmpIs_completed = _tmp_1 != 0;
        _result = new Task(_tmpTitle,_tmpAuthor,_tmpDescription,_tmpCreatedDate,_tmpIs_completed);
        final int _tmpId;
        _tmpId = _cursor.getInt(_cursorIndexOfId);
